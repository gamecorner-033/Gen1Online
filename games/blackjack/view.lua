...
local function color(c) end
local function rect(mode, x, y, w, h) end
...
local function chip(x, y, active)
  color(C.ink, 0.5); do end
  color(active and C.gold or C.paperShade); do end
  color(active and C.red or C.back); do end
  color(C.paper); do end
  for a = 0, 7 do
